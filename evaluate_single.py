...
def viz(img, flo, flow_dir):
    ...
    imageio.imwrite(os.path.join(flow_dir, '1-5.jpg'), flo)
...
def demo(args):
    ...
    with torch.no_grad():
        ...
        for imfile1, imfile2 in zip(images[:-1], images[1:]):
            image1 = load_image('D:\\CEDp\\demo-frames\\VBOF\\canon\\10_5.jpg')
            image2 = load_image('D:\\CEDp\\demo-frames\\VBOF\\canon\\10_5.jpg')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='D:\\CEDp\\checkpoints\\Mixed-45.pth',help="restore checkpoint")
    parser.add_argument('--model_name', default="overexp")
    parser.add_argument('--path', default='D:\\CEDp\\demo-frames',help="dataset for evaluation")
