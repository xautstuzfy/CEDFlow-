...
#     def __init__(self, aug_params=None, split='training', root='E:\\GMA-main\\datasets\\FlyingChairs_release\\data'):
...
#
#         split_list = np.loadtxt('E:\\GMA-main\\things_val_test_set.txt', dtype=np.int32)
...
# D:\CGDFlow\datasets\canon\canon_fusion D:\\make_VBOF\\sony3\\fusion
class Canon(FlowDataset):
    def __init__(self, aug_params=None, split='train', root='D:\\make_VBOF\\sony3\\fusion'):
        super(Canon, self).__init__(aug_params)
...
class FlyingChairs(FlowDataset):
    def __init__(self, aug_params=None, split='train', root='D:\\CGDFlow\\datasets\\FlyingChairs_release\\data'):
        super(FlyingChairs, self).__init__(aug_params)
...
def fetch_dataloader(args, TRAIN_DS='C+T+K+S+H'):
    ...
    if args.stage == 'chairs':
        ...
        aug_params = {'crop_size': args.image_size, 'min_scale': -0.1, 'max_scale': 1.0, 'do_flip': True}
        train_dataset = Canon(aug_params, split='training')
